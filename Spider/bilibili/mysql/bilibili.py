...
# -*- coding: utf-8 -*-
__author__ = 'netuser'
from Spider.spider import SpiderHTML
        ...
        for (order, name) in orders.items():
            ...
            for page in range(1, 5):
                ...
                for video in videoList:
                    ...
                    args = (AVInfo['av'], AVInfo['title'], AVInfo['module'], AVInfo['tid'], AVInfo['author'],
                            AVInfo['author_name'], AVInfo['play'], AVInfo['danmu'], AVInfo['collect'], AVInfo['desc'],
                            AVInfo['share'], AVInfo['coin'], AVInfo['mtime'], AVInfo['ctime'])
